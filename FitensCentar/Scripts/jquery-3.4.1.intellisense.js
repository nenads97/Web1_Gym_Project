intellisense.annotate(jQuery, {
  ...
  'ajaxTransport': function() {
    /// <signature>
    ///   <summary>Creates an object that handles the actual transmission of Ajax podaci.</summary>
    ///   <param name="dataType" type="String">A string identifying the podaci type to use</param>
    ///   <param name="handler(options, originalOptions, jqXHR)" type="Function">A handler to return the new transport object to use with the podaci type provided in the first argument.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'get': function() {
    /// <signature>
    ///   <summary>Load podaci from the server using a HTTP GET request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="podaci" type="">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(podaci, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of podaci expected from the server. Default: Intelligent Guess (xml, json, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'getJSON': function() {
    /// <signature>
    ///   <summary>Load JSON-encoded podaci from the server using a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="podaci" type="PlainObject">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(podaci, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'hasData': function() {
    /// <signature>
    ///   <summary>Determine whether an element has any jQuery podaci associated with it.</summary>
    ///   <param name="element" type="Element">A DOM element to be checked for podaci.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'holdReady': function() {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="podaci" type="String">HTML string to be parsed</param>
  ...
  'parseXML': function() {
    ...
    ///   <param name="podaci" type="String">a well-formed XML string to be parsed</param>
    ///   <returns type="XMLDocument" />
    /// </signature>
  },
  'post': function() {
    /// <signature>
    ///   <summary>Load podaci from the server using a HTTP POST request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="podaci" type="">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(podaci, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds. Required if dataType is provided, but can be null in that case.</param>
    ///   <param name="dataType" type="String">The type of podaci expected from the server. Default: Intelligent Guess (xml, json, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of podaci.</summary>
    ///   <param name="element" type="Element">A DOM element from which to remove podaci.</param>
    ///   <param name="name" type="String">A string naming the piece of podaci to remove.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'sub': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'podaci': function() {
    /// <summary>An optional object of podaci passed to an event method when the current executing handler is bound.</summary>
    /// <returns type="Object" />
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'bind': function() {
    ...
    ///   <param name="eventData" type="Object">An object containing podaci that will be passed to the event handler.</param>
  ...
  'clone': function() {
    ...
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers should be copied along with the elements. As of jQuery 1.4, element podaci will be copied as well.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and podaci should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and podaci for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'podaci': function() {
    /// <signature>
    ///   <summary>Store arbitrary podaci associated with the matched elements.</summary>
    ///   <param name="key" type="String">A string naming the piece of podaci to set.</param>
    ///   <param name="value" type="Object">The new podaci value; it can be any Javascript type including Array or Object.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Store arbitrary podaci associated with the matched elements.</summary>
    ///   <param name="obj" type="Object">An object of key-value pairs of podaci to update.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dblclick': function() {
  ...
  'keydown': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "keydown" JavaScript event, or trigger that event on an element.</summary>
    ///   <param name="eventData" type="PlainObject">An object containing podaci that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'live': function() {
    ...
    ///   <summary>Attach an event handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript event type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated event types or custom event names.</param>
    ///   <param name="podaci" type="PlainObject">An object containing podaci that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'on': function() {
    ...
    ///   <param name="podaci" type="Anything">Data to be passed to the handler in event.podaci when an event is triggered.</param>
    ...
    ///   <param name="podaci" type="Anything">Data to be passed to the handler in event.podaci when an event occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of podaci.</summary>
    ///   <param name="name" type="String">A string naming the piece of podaci to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-stored piece of podaci.</summary>
    ///   <param name="list" type="">An array or space-separated string naming the pieces of podaci to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'removeProp': function() {
  ...
  'unload': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "unload" JavaScript event.</summary>
    ///   <param name="eventData" type="Object">A plain object of podaci that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
